...
export default function FileTree({ projectName, onFileOpen }: Props) {
    ...
    useEffect(() => {
        console.log(
            "[FileTree] inlineInput useEffect fired, inlineInput:",
            inlineInput,
        );
    ...
    const renderTree = useCallback(
        (folderPath: string, depth: number) => {
            console.log(
                "[FileTree] renderTree called with folderPath:",
                folderPath,
                "depth:",
                depth,
            );
            ...
            console.log(
                "[FileTree] contents at folderPath:",
                contents[folderPath],
            );
                    ...
                    <View style={styles.header}>
                        ...
                        <View style={styles.headerButtons}>
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    console.log(
                                        "[FileTree] New file button pressed",
                                    );
                                    console.log(
                            ...
                            <TouchableOpacity
                                ...
                                onPress={() => {
                                    console.log(
                                        "[FileTree] New folder button pressed",
                                    );
                                    console.log(
                                        "[FileTree] Setting inlineInput to:",
                                        { path: "", type: "folder" },
